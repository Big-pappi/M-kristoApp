export const colors = {
  light: {
    background: "#FBF7EF", backgroundAlt: "#F2EBDD", surface: "#FFFFFF", surfaceMuted: "#F1EBDD", surfaceRaised: "#FFFFFF",
    border: "#DED3BB", borderStrong: "#CBB98D", text: "#221B10", textMuted: "#6B6250", textFaint: "#9A9078",
    primary: "#2B2560", primaryMuted: "#413A7E", primaryDeep: "#191338", primaryForeground: "#FFFFFF", primarySoft: "#E9E7F4",
    accent: "#C99A3E", accentSoft: "#F6EBD5", accentForeground: "#221B10", success: "#2F6D4F", danger: "#A6382C",
    overlay: "rgba(25,19,56,0.55)", scrim: "rgba(25,19,56,0.88)", onImage: "#FFFFFF", onImageMuted: "rgba(255,255,255,0.72)",
  },
  dark: {
    background: "#0F0C22", backgroundAlt: "#15122A", surface: "#1B1738", surfaceMuted: "#241F49", surfaceRaised: "#221D44",
    border: "#332C5C", borderStrong: "#463D75", text: "#F4F0E4", textMuted: "#B0A8CF", textFaint: "#7C749D",
    primary: "#9A92E4", primaryMuted: "#7E76C8", primaryDeep: "#080618", primaryForeground: "#0F0C22", primarySoft: "#272252",
    accent: "#E0B767", accentSoft: "#332A1B", accentForeground: "#15122A", success: "#4E9E77", danger: "#D96B5C",
